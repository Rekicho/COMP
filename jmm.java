...
jjtn000.type = "while";
        ...
        default:
          ...
          if (jj_2_5(2147483647)) {
            ...
            Expression();
            jj_consume_token(SEMICOLON);
jjtn000.type = "[]="; jjtn000.identifier = t.image;
          } else if (jj_2_6(2)) {
            t = jj_consume_token(IDENTIFIER);
            jj_consume_token(ASSIGN);
            Expression();
...
if (jjtc000) {
  ...
  static final public void OtherLiteral() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACKET:{
      ArrayAcc();
      OtherLiteral();
...
jjtree.closeNodeScope(jjtn003, true);
                                                                                                                                                jjtc003 = false;
jjtn003.type = "call"; jjtn003.identifier = t.image;
        } finally {
if (jjtc003) {
                                                                                                                                                  jjtree.closeNodeScope(jjtn003, true);
                                                                                                                                                }
  ...
  static private boolean jj_3_3()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000,0x8008200,0x80000,0x8208200,0x8008200,0x0,0x0,0x8008200,0xbd846000,0x84004000,0x39842000,0x0,0x0,0x8008000,0x39842000,0x39842000,0x8010000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x10,0x2,0x0,0x100,0x0,0x100,0xc00,0x3000,0x0,0x100,0x100,0x0,0x22,0x10,};
   }
